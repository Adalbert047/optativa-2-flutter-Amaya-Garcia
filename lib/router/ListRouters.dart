...
class ListRouters {
  static final Map<String, Widget Function(BuildContext)> listScreen = {
      ...
      // Routers.product: (context) => const ProductScreen()
    ...
    // MenuOption(description: "Pantalla de empleados", route: Routers.empleados, screen: const Empleados(), icon: Icons.security)
  ];
}