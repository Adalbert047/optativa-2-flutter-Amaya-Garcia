...
class ListRouters {
  static final Map<String, Widget Function(BuildContext)> listScreen = {
      ...
      Routers.product: (context) => DetaildProductScreen()
    ...
    MenuOption(description: "Pantalla de Detalle de product", route: Routers.product, screen: DetaildProductScreen(), icon: Icons.security)
  ];
}